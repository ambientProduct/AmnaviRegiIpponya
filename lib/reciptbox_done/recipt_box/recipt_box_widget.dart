...
import 'recipt_box_model.dart';
export 'recipt_box_model.dart';

class ReciptBoxWidget extends StatefulWidget {
  const ReciptBoxWidget({super.key});

  @override
  State<ReciptBoxWidget> createState() => _ReciptBoxWidgetState();
}

class _ReciptBoxWidgetState extends State<ReciptBoxWidget> {
  late ReciptBoxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReciptBoxModel());
