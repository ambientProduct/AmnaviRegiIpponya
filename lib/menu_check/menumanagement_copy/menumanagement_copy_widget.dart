...
import 'menumanagement_copy_model.dart';
export 'menumanagement_copy_model.dart';

class MenumanagementCopyWidget extends StatefulWidget {
  const MenumanagementCopyWidget({super.key});

  @override
  State<MenumanagementCopyWidget> createState() =>
      _MenumanagementCopyWidgetState();
}

class _MenumanagementCopyWidgetState extends State<MenumanagementCopyWidget> {
  late MenumanagementCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenumanagementCopyModel());
