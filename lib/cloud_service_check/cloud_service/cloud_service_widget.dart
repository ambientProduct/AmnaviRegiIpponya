...
export 'cloud_service_model.dart';

class CloudServiceWidget extends StatefulWidget {
  const CloudServiceWidget({super.key});

  @override
  State<CloudServiceWidget> createState() => _CloudServiceWidgetState();
}

class _CloudServiceWidgetState extends State<CloudServiceWidget> {
  late CloudServiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CloudServiceModel());
