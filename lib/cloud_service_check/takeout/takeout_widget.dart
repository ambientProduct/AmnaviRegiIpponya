...
import 'takeout_model.dart';
export 'takeout_model.dart';

class TakeoutWidget extends StatefulWidget {
  const TakeoutWidget({super.key});

  @override
  State<TakeoutWidget> createState() => _TakeoutWidgetState();
}

class _TakeoutWidgetState extends State<TakeoutWidget> {
  late TakeoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TakeoutModel());
